...
angular.module('ion-floating-menu', [])
        ...
        .directive('ionFloatingButtonLeft', function () {
            ...
            return {
                ...
                template: '<ul id="floating-button-left" ng-style="{\'bottom\' : \'{{bottomValue}}\' }">' +
                        '<li ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }">' +
                        '<a ng-click="showLeftMenu();"><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></a>' +
                        '</li>' +
                        '</ul>',
                replace: true,
                transclude: true,
    ...
    .directive('ionFloatingButtonRight', function () {
        ...
        return {
            ...
            template: '<ul id="floating-button-right" ng-style="{\'bottom\' : \'{{bottomValue}}\' }">' +
                    '<li ng-class="buttonClass" ng-style="{\'background-color\': buttonColor }">' +
                    '<a ng-click="click()"><i class="icon menu-icon" ng-class="{ \'{{icon}}\' : true}" ng-style="{\'color\': iconColor }"></i></a>' +
                    '</li>' +
                    '</ul>',
